...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fourquantumwire = QtGui.QRadioButton(self.groupBox)
        self.fourquantumwire.setGeometry(QtCore.QRect(10, 60, 120, 17))
        self.fourquantumwire.setText(QtGui.QApplication.translate("MainWindow", "Quantum Wire x4", None, QtGui.QApplication.UnicodeUTF8))
        self.fourquantumwire.setObjectName(_fromUtf8("fourquantumwire"))
